...
function renderMenuSection($conn, $category, $meal_op)
{
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            ?>
            <div class="card menu-card" data-id="<?= htmlspecialchars($row['id']) ?>"
                data-name="<?= htmlspecialchars($row['name']) ?>" data-rating="<?= htmlspecialchars($row['rating']) ?>"
                ...
                data-status="<?= htmlspecialchars($row['status']) ?>" data-type="menu_item"
                ...
                <div class="card-actions">
                    <button class="add-to-cart primary-btn" data-id="<?= $row['id'] ?>" <?= $isOutOfStock ? 'disabled' : '' ?>>Add To
                        Cart</button>
                </div>
            </div>
            <?php
            ...
            <div class="popup-right">
                ...
                <div class="quantity-add">
                    ...
                    <div class="action-buttons">
                        ...
                        <button class="buy-now-btn secondary-btn" id="popup-buy-now" onclick="buyNow(this)"
                            data-id="">Buy Now</button>
