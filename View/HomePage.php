...
<section class="quick-pick-menu container">
  ...
  <div class="menu-content">
    <div class="home-category-section active" id="Starter">
      ...
      <a href="menu.php?category=starter" class="view-menu primary-btn">View Menu <i class="fa-solid fa-arrow-right"></i> </a>
    </div>
    ...
    <div class="home-category-section" id="Soup">
      ...
      <a href="menu.php?category=soup" class="view-menu primary-btn">View Menu <i class="fa-solid fa-arrow-right"></i></a>
    </div>
    ...
    <div class="home-category-section" id="Noodles">
      ...
      <a href="menu.php?category=noodles" class="view-menu primary-btn">View Menu <i class="fa-solid fa-arrow-right"></i></a>
    </div>
    ...
    <div class="home-category-section" id="Rice">
      ...
      <a href="menu.php?category=rice" class="view-menu primary-btn">View Menu <i class="fa-solid fa-arrow-right"></i> </a>
    </div>
