...
<section class="About-Banner container">
    <div class="About-banner-text">
        <h1>WELCOME!!</h1>
        <h4>Who We Are</h4>
        <p>"DeepSagar is Family chinese Restuarant that works to make your life easier. We take responsiblity for making
            sure that your orders from restaurants are delivered to you safely and quickly"</p>
    ...
    <div class="Banner-text">
        ...
        <div class="partition">
            <div class="Para-part-first">
                "We've made things doubly easy for you by providing takeaway options as well as door-to-door delivery
                every day"
            </div>
...
<section class="About-team-member container">
    <h2>Our Team</h2>
    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Hic placeat cupiditate, molestias officia minima vel
        repudiandae magni culpa consectetur laudantium quas, qui praesentium commodi ex fugit accusantium, voluptas
